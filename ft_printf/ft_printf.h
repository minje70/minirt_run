...
/*   Updated: 2020/11/25 13:04:46 by mijeong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**ft_checking.c
*/
int							check_astro(char **str, t_key *key, int *i,
									int pw_switch);
...
**cd_printing.c
*/
int							align_check(int count, t_key *key,
...
void						ft_putunbr_fd(unsigned long long int n,
									t_key *key);
int							s_align_check(int count, t_key *key);
/*
**xp_printing.c
*/
void						print_hex(unsigned long long n, int ud,
									t_key *key);
...
int							f_align_check(int count, t_key *key,
									union u_f result);
void						putdecimal(t_key *key, union u_f result,
									int count);
